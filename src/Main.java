...
import service.strategies.EqualSplitStrategy;
import service.strategies.ExactSplitStrategy;
import service.strategies.PercentageSplitStrategy;
...
public class Main {
    public static void main(String[] args) {
        ...
        Expense expense = groupService.addExpense(tripToGoa, u1, List.of(u1, u2), 1500.0, new PercentageSplitStrategy(), List.of(50, 50));
        groupService.showBalances(group.getName());

        groupService.addExpense(group.getName(), u2, List.of(u1, u2, u3),1100.0, new ExactSplitStrategy(), List.of(200.0, 800.0, 100.0));
        groupService.showBalances(group.getName());
